...
# print(df.sort_values('Liczba', ascending=False).groupby(['Rok', 'Plec']).first()) # to jest to samo co wyżej
...
#       agg({'Utarg': ['sum']}))
# print('')
# print(df[df['Data zamowienia'].str[:4] == '2004'].agg({'Utarg': ['mean']})) # mean = średnia
